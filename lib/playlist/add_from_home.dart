...
class AddFromHome extends StatefulWidget {
  int songindex;
  AddFromHome({super.key, required this.songindex});

  @override
  State<AddFromHome> createState() => _AddFromHomeState();
}

class _AddFromHomeState extends State<AddFromHome> {
                        ...
                        Expanded(
                            child: ListView.separated(
                                ...
                                separatorBuilder: (context, index) {
                                  return const Divider(color: CustomColors.lightGrey,);
                                },
